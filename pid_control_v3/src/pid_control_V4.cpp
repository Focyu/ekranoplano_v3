  ...
  ros_slros2_internal_block_Pub_T *obj)
{
  ...
  Pub_pid_control_V3_548.createPublisher(&pid_control_V4_B.b_zeroDelimTopic_p[0],
    qos_profile);
}
  ...
  ros_slros2_internal_block_Sub_T *obj)
{
  ...
  Sub_pid_control_V3_435.createSubscriber(&pid_control_V4_B.b_zeroDelimTopic_b[0],
    qos_profile);
}
  ...
  ros_slros2_internal_block_Sub_T *obj)
{
  ...
  Sub_pid_control_V3_417.createSubscriber(&pid_control_V4_B.b_zeroDelimTopic_k[0],
    qos_profile);
}
  ...
  ros_slros2_internal_block_Sub_T *obj)
{
  ...
  Sub_pid_control_V3_423.createSubscriber(&pid_control_V4_B.b_zeroDelimTopic_c[0],
    qos_profile);
}
  ...
  ros_slros2_internal_block_Sub_T *obj)
{
  ...
  Sub_pid_control_V3_445.createSubscriber(&pid_control_V4_B.b_zeroDelimTopic_cx
    [0], qos_profile);
}
...
void pid_control_V4::step()
{
  ...
  memset(&pid_control_V4_B.BusAssignment1, 0, sizeof(SL_Bus_sensor_msgs_Imu));
  ...
  pid_control_V4_B.SignPreSat = pid_control_V4_B.cosa * pid_control_V4_B.cosb;

  /* MATLABSystem: '<Root>/Coordinate Transformation Conversion' */
  pid_control_V4_B.CoordinateTransformationConvers[0] = pid_control_V4_B.sina *
    pid_control_V4_B.sinb * pid_control_V4_B.sinc + pid_control_V4_B.SignPreSat *
    pid_control_V4_B.cosc;
  pid_control_V4_B.CoordinateTransformationConvers[1] =
    pid_control_V4_B.SignPreSat * pid_control_V4_B.sinc - pid_control_V4_B.cosc *
    pid_control_V4_B.sina * pid_control_V4_B.sinb;
  pid_control_V4_B.CoordinateTransformationConvers[2] = pid_control_V4_B.cosa *
    pid_control_V4_B.cosc * pid_control_V4_B.sinb + pid_control_V4_B.cosb *
    pid_control_V4_B.sina * pid_control_V4_B.sinc;
  pid_control_V4_B.CoordinateTransformationConvers[3] = pid_control_V4_B.cosb *
  ...
  /* BusAssignment: '<Root>/Bus Assignment1' */
  pid_control_V4_B.BusAssignment1.orientation.x =
    pid_control_V4_B.CoordinateTransformationConvers[3];
  pid_control_V4_B.BusAssignment1.orientation.y =
    pid_control_V4_B.CoordinateTransformationConvers[2];
  pid_control_V4_B.BusAssignment1.orientation.z =
    pid_control_V4_B.CoordinateTransformationConvers[3];
  pid_control_V4_B.BusAssignment1.orientation.w =
    pid_control_V4_B.CoordinateTransformationConvers[0];
  pid_control_V4_B.BusAssignment1.angular_velocity.x = pid_control_V4_B.x[3];
  pid_control_V4_B.BusAssignment1.angular_velocity.y = pid_control_V4_B.x[4];
  pid_control_V4_B.BusAssignment1.angular_velocity.z = pid_control_V4_B.x[5];
  memcpy(&pid_control_V4_B.BusAssignment1.header.frame_id[0],
         &pid_control_V4_B.sf_MATLABFunctionIMU2.stringOut[0], sizeof(uint8_T) <<
         7U);
  pid_control_V4_B.BusAssignment1.header.frame_id_SL_Info.CurrentLength =
    pid_control_V4_B.sf_MATLABFunctionIMU2.lengthOut;

  /* MATLABSystem: '<S12>/SinkBlock' */
  Pub_pid_control_V3_548.publish(&pid_control_V4_B.BusAssignment1);
  if (tmp_0) {
    /* MATLABSystem: '<S14>/SourceBlock' */
    pid_control_V4_B.SourceBlock_o1_o = Sub_pid_control_V3_435.getLatestMessage(
  ...
  /* Gain: '<Root>/Gain' */
  pid_control_V4_B.Gain = -pid_control_V4_B.x[11];

  /* Sum: '<Root>/Sum2' incorporates:
   *  Gain: '<Root>/Gain4'
   */
  pid_control_V4_B.cosb = pid_control_V4_B.Switch3 - (-pid_control_V4_B.x[11]);
  ...
  if (pid_control_V4_B.cosc > 20.0) {
    /* Saturate: '<S111>/Saturation' */
    pid_control_V4_B.Saturation = 20.0;
  } else if (pid_control_V4_B.cosc < -20.0) {
    /* Saturate: '<S111>/Saturation' */
    pid_control_V4_B.Saturation = -20.0;
  } else {
    /* Saturate: '<S111>/Saturation' */
  ...
  if (tmp_0) {
    ...
    pid_control_V4_B.SourceBlock_o1 = Sub_pid_control_V3_377.getLatestMessage
  ...
  if (pid_control_V4_B.Saturation > 0.13962634015954636) {
    /* Saturate: '<Root>/Saturation' */
    pid_control_V4_B.Saturation_i = 0.13962634015954636;
  } else if (pid_control_V4_B.Saturation < -0.13962634015954636) {
    /* Saturate: '<Root>/Saturation' */
    pid_control_V4_B.Saturation_i = -0.13962634015954636;
  } else {
    /* Saturate: '<Root>/Saturation' */
    pid_control_V4_B.Saturation_i = pid_control_V4_B.Saturation;
  }
  ...
  if (pid_control_V4_DW.LastMajorTime == (rtInf)) {
    /* RateLimiter: '<Root>/Rate Limiter' */
    pid_control_V4_B.RateLimiter = pid_control_V4_B.Saturation_i;
  } else {
    ...
    if (pid_control_V4_DW.LastMajorTime == pid_control_V4_B.cosa) {
      ...
      pid_control_V4_B.cosa = pid_control_V4_B.Saturation_i -
  ...
  pid_control_V4_B.R_tmp_f = pid_control_V4_B.c_phi * pid_control_V4_B.s_the;
  pid_control_V4_B.R[6] = pid_control_V4_B.R_tmp_f * pid_control_V4_B.c_psi +
  ...
  pid_control_V4_B.R[7] = pid_control_V4_B.R_tmp_f * pid_control_V4_B.s_psi -
   ...
   *  Gain: '<Root>/Gain6'
   */
  memset(&pid_control_V4_B.BusAssignment, 0, sizeof
         (SL_Bus_gazebo_msgs_SetEntityStateRequest));
  pid_control_V4_B.BusAssignment.state.pose.position.x = pid_control_V4_B.x[10];
  pid_control_V4_B.BusAssignment.state.pose.position.y = -pid_control_V4_B.x[9];
  pid_control_V4_B.BusAssignment.state.pose.position.z = pid_control_V4_B.Gain;
  pid_control_V4_B.BusAssignment.state.pose.orientation.w =
    pid_control_V4_B.CoordinateTransformationConvers[0];
  pid_control_V4_B.BusAssignment.state.pose.orientation.z =
    pid_control_V4_B.CoordinateTransformationConvers[3];
  pid_control_V4_B.BusAssignment.state.pose.orientation.y =
    pid_control_V4_B.CoordinateTransformationConvers[2];
  pid_control_V4_B.BusAssignment.state.pose.orientation.x =
    pid_control_V4_B.CoordinateTransformationConvers[1];
  memcpy(&pid_control_V4_B.BusAssignment.state.name[0],
         &pid_control_V4_B.sf_MATLABFunction.stringOut[0], sizeof(uint8_T) << 7U);
  memcpy(&pid_control_V4_B.BusAssignment.state.reference_frame[0],
         &pid_control_V4_B.stringOut[0], sizeof(uint8_T) << 7U);
  pid_control_V4_B.BusAssignment.state.name_SL_Info.CurrentLength =
    pid_control_V4_B.sf_MATLABFunction.lengthOut;
  pid_control_V4_B.BusAssignment.state.reference_frame_SL_Info.CurrentLength =
  ...
  if (serverAvailableOnTime) {
    ServCall_pid_control_V3_326.call(&pid_control_V4_B.BusAssignment, &tmp);
  }
   ...
   */
  pid_control_V4_B.AND3 = ((pid_control_V4_B.beta != pid_control_V4_B.SignPreSat)
    && (i == tmp_2));
  if (tmp_0) {
    /* Memory: '<S42>/Memory' */
  ...
  /* Gain: '<S252>/ZeroGain' */
  pid_control_V4_B.sinb = 0.0 * pid_control_V4_B.sina;
  ...
  if (rtIsNaN(pid_control_V4_B.sina)) {
    ...
    if (pid_control_V4_B.sina < 0.0) {
      ...
      /* DataTypeConversion: '<S252>/DataTypeConv1' */
      pid_control_V4_B.w_r = (pid_control_V4_B.sina > 0.0);
    }
   ...
   */
  pid_control_V4_B.AND3_c = ((pid_control_V4_B.sinb != pid_control_V4_B.sina) &&
    (i == tmp_2));
  if (tmp_0) {
    /* Memory: '<S252>/Memory' */
  ...
  pid_control_V4_B.sinb = 3.280839895013123 * -pid_control_V4_B.x[11];
  ...
  /* Unit Conversion - from: m/s to: ft/s
     Expression: output = (3.28084*input) + (0) */
  pid_control_V4_B.sinc = 3.280839895013123 * pid_control_V4_B.cosa;

  /* Saturate: '<S325>/Limit Function 10ft to 1000ft' incorporates:
   *  Saturate: '<S308>/Limit Height h<1000ft'
   */
  if (pid_control_V4_B.sinb > 1000.0) {
    pid_control_V4_B.cosa = 1000.0;
    pid_control_V4_B.sina = 1000.0;
  } else {
    if (pid_control_V4_B.sinb < 10.0) {
      pid_control_V4_B.cosa = 10.0;
    } else {
      pid_control_V4_B.cosa = pid_control_V4_B.sinb;
    }

    if (pid_control_V4_B.sinb < 0.0) {
      pid_control_V4_B.sina = 0.0;
    } else {
      pid_control_V4_B.sina = pid_control_V4_B.sinb;
    }
  ...
  pid_control_V4_B.cosc = pid_control_V4_B.cosa / rt_powd_snf(0.000823 *
    pid_control_V4_B.cosa + 0.177, 1.2);

  /* Product: '<S308>/sigma_ug, sigma_vg' incorporates:
   *  Fcn: '<S308>/Low Altitude Intensity'
   */
  pid_control_V4_B.cosb = 1.0 / rt_powd_snf(0.000823 * pid_control_V4_B.sina +
   ...
   */
  pid_control_V4_B.bpIndex[0] = plook_bincpa(pid_control_V4_B.sinb,
  ...
  if (pid_control_V4_DW.Hugws_MODE) {
    /* Product: '<S304>/Lug//V' */
    pid_control_V4_B.frac[0] = pid_control_V4_B.cosc / pid_control_V4_B.sinc;
    ...
    tmp_3 = _mm_mul_pd(_mm_loadu_pd(&pid_control_V4_X.ug_p_CSTATE[0]),
                       _mm_set_pd(pid_control_V4_B.sina, pid_control_V4_B.cosb));
  ...
  if (pid_control_V4_DW.Hvgws_MODE) {
     ...
     *  Gain: '<S297>/Lv'
     */
    pid_control_V4_B.cosc /= pid_control_V4_B.sinc;
     ...
     *  Sum: '<S305>/Sum'
     */
    pid_control_V4_B.SignPreSat = (sqrt(0.31830988618379069 *
      pid_control_V4_B.cosc) * pid_control_V4_B.Product[1] -
      pid_control_V4_X.vg_p1_CSTATE[0]) / pid_control_V4_B.cosc;
    pid_control_V4_B.w_g[0] = pid_control_V4_B.SignPreSat;
     ...
     *  Sum: '<S305>/Sum1'
     */
    pid_control_V4_B.w_e[0] = (pid_control_V4_B.SignPreSat *
      pid_control_V4_B.cosc * 1.7320508075688772 +
      (pid_control_V4_X.vg_p1_CSTATE[0] - pid_control_V4_X.vgw_p2_CSTATE[0])) /
      pid_control_V4_B.cosc;

    /* Product: '<S305>/Lvg//V' */
    pid_control_V4_B.cosc = pid_control_V4_B.frac[1] / pid_control_V4_B.sinc;
    ...
    pid_control_V4_B.SignPreSat = (sqrt(0.31830988618379069 *
      pid_control_V4_B.cosc) * pid_control_V4_B.Product[1] -
      pid_control_V4_X.vg_p1_CSTATE[1]) / pid_control_V4_B.cosc;
    pid_control_V4_B.w_g[1] = pid_control_V4_B.SignPreSat;
     ...
     *  Sum: '<S305>/Sum1'
     */
    pid_control_V4_B.w_e[1] = (pid_control_V4_B.SignPreSat *
      pid_control_V4_B.cosc * 1.7320508075688772 +
      (pid_control_V4_X.vg_p1_CSTATE[1] - pid_control_V4_X.vgw_p2_CSTATE[1])) /
      pid_control_V4_B.cosc;

    /* Product: '<S305>/w 1' incorporates:
     *  Integrator: '<S305>/vgw_p2'
     */
    tmp_3 = _mm_mul_pd(_mm_set_pd(pid_control_V4_B.sina, pid_control_V4_B.cosb),
  ...
  if (pid_control_V4_DW.Hwgws_MODE) {
     ...
     *  Gain: '<S297>/Lw'
     */
    pid_control_V4_B.cosb = pid_control_V4_B.cosa / pid_control_V4_B.sinc;
     ...
     *  Sum: '<S306>/Sum'
     */
    pid_control_V4_B.cosc = (sqrt(0.31830988618379069 * pid_control_V4_B.cosb) *
      pid_control_V4_B.Product[2] - pid_control_V4_X.wg_p1_CSTATE[0]) /
      pid_control_V4_B.cosb;
    pid_control_V4_B.w[0] = pid_control_V4_B.cosc;
     ...
     *  Sum: '<S306>/Sum1'
     */
    pid_control_V4_B.w_a[0] = (pid_control_V4_B.cosc *
      pid_control_V4_ConstB.sqrt_a * pid_control_V4_B.cosb +
      (pid_control_V4_X.wg_p1_CSTATE[0] - pid_control_V4_X.wg_p2_CSTATE[0])) /
      pid_control_V4_B.cosb;

    /* Product: '<S306>/Lwg//V' */
    pid_control_V4_B.cosb = pid_control_V4_B.frac[1] / pid_control_V4_B.sinc;
    ...
    pid_control_V4_B.cosc = (sqrt(0.31830988618379069 * pid_control_V4_B.cosb) *
      ...
      pid_control_V4_B.cosb;
    pid_control_V4_B.w[1] = pid_control_V4_B.cosc;
     ...
     *  Sum: '<S306>/Sum1'
     */
    pid_control_V4_B.w_a[1] = (pid_control_V4_B.cosc *
      pid_control_V4_ConstB.sqrt_a * pid_control_V4_B.cosb +
  ...
  pid_control_V4_B.cosc = sin(pid_control_V4_B.x[6]);
  pid_control_V4_B.SignPreSat = -sin(pid_control_V4_B.x[6]);
  pid_control_V4_B.Sum1_g = cos(pid_control_V4_B.x[6]);
  pid_control_V4_B.CD_iw_IGE = cos(pid_control_V4_B.x[7]);
  pid_control_V4_B.Ltot = -sin(pid_control_V4_B.x[7]);
  pid_control_V4_B.Sum_hl = sin(pid_control_V4_B.x[7]);
  pid_control_V4_B.w_r = cos(pid_control_V4_B.x[7]);
  pid_control_V4_B.beta = cos(pid_control_V4_B.x[8]);
  pid_control_V4_B.hh = sin(pid_control_V4_B.x[8]);
  pid_control_V4_B.hw = -sin(pid_control_V4_B.x[8]);
  pid_control_V4_B.CD_ih_IGE = cos(pid_control_V4_B.x[8]);
  pid_control_V4_B.CL_w_IGE = 0.0 * pid_control_V4_B.Sum_hl +
    pid_control_V4_B.CD_iw_IGE;
  pid_control_V4_B.CL_h_IGE = 0.0 * pid_control_V4_B.w_r + pid_control_V4_B.Ltot;
  pid_control_V4_B.u2_deg = pid_control_V4_B.beta * 0.0;
  pid_control_V4_B.Ltot_tmp = 0.0 * pid_control_V4_B.CD_iw_IGE;
  pid_control_V4_B.CD_iw_IGE = (pid_control_V4_B.Ltot_tmp +
    pid_control_V4_B.u2_deg) + pid_control_V4_B.hh * pid_control_V4_B.Sum_hl;
  pid_control_V4_B.beta += pid_control_V4_B.hh * 0.0;
  pid_control_V4_B.Ltot *= 0.0;
  pid_control_V4_B.hh = (pid_control_V4_B.Ltot + pid_control_V4_B.u2_deg) +
    pid_control_V4_B.hh * pid_control_V4_B.w_r;
  pid_control_V4_B.u2_deg = pid_control_V4_B.hw * 0.0;
  pid_control_V4_B.Sum_hl = (pid_control_V4_B.Ltot_tmp + pid_control_V4_B.u2_deg)
    + pid_control_V4_B.Sum_hl * pid_control_V4_B.CD_ih_IGE;
  pid_control_V4_B.hw += pid_control_V4_B.CD_ih_IGE * 0.0;
  pid_control_V4_B.w_r = (pid_control_V4_B.Ltot + pid_control_V4_B.u2_deg) +
    pid_control_V4_B.CD_ih_IGE * pid_control_V4_B.w_r;
  pid_control_V4_B.CD_ih_IGE = pid_control_V4_B.CL_h_IGE * 0.0;
  pid_control_V4_B.RotationAnglestoDirectionCo[0] = (pid_control_V4_B.CL_w_IGE *
    pid_control_V4_B.cosb + 0.0 * pid_control_V4_B.SignPreSat) +
    pid_control_V4_B.CD_ih_IGE;
  pid_control_V4_B.u2_deg = pid_control_V4_B.hh * 0.0;
  pid_control_V4_B.RotationAnglestoDirectionCo[1] = (pid_control_V4_B.cosb *
    pid_control_V4_B.CD_iw_IGE + pid_control_V4_B.SignPreSat *
    pid_control_V4_B.beta) + pid_control_V4_B.u2_deg;
  pid_control_V4_B.Ltot_tmp = pid_control_V4_B.w_r * 0.0;
  pid_control_V4_B.RotationAnglestoDirectionCo[2] = (pid_control_V4_B.cosb *
    pid_control_V4_B.Sum_hl + pid_control_V4_B.SignPreSat * pid_control_V4_B.hw)
    + pid_control_V4_B.Ltot_tmp;
  pid_control_V4_B.RotationAnglestoDirectionCo[3] = (pid_control_V4_B.CL_w_IGE *
    pid_control_V4_B.cosc + 0.0 * pid_control_V4_B.Sum1_g) +
    pid_control_V4_B.CD_ih_IGE;
  pid_control_V4_B.RotationAnglestoDirectionCo[4] = (pid_control_V4_B.cosc *
    pid_control_V4_B.CD_iw_IGE + pid_control_V4_B.beta * pid_control_V4_B.Sum1_g)
    + pid_control_V4_B.u2_deg;
  pid_control_V4_B.RotationAnglestoDirectionCo[5] = (pid_control_V4_B.cosc *
    pid_control_V4_B.Sum_hl + pid_control_V4_B.Sum1_g * pid_control_V4_B.hw) +
    pid_control_V4_B.Ltot_tmp;
  pid_control_V4_B.RotationAnglestoDirectionCo[6] = pid_control_V4_B.CL_w_IGE *
    0.0 + pid_control_V4_B.CL_h_IGE;
  pid_control_V4_B.RotationAnglestoDirectionCo[7] = (pid_control_V4_B.CD_iw_IGE *
    0.0 + pid_control_V4_B.beta * 0.0) + pid_control_V4_B.hh;
  pid_control_V4_B.RotationAnglestoDirectionCo[8] = (pid_control_V4_B.Sum_hl *
    0.0 + pid_control_V4_B.hw * 0.0) + pid_control_V4_B.w_r;
  ...
  if (tmp_1) {
    if (pid_control_V4_B.sinb <= 1000.0) {
      rtAction = 0;
    } else if (pid_control_V4_B.sinb >= 2000.0) {
      rtAction = 1;
    } else {
      rtAction = 2;
    }
  ...
  switch (rtAction) {
   case 0:
     ...
     */
    pid_control_V4_B.cosb = sin(pid_control_V4_ConstB.UnitConversion);
    pid_control_V4_B.cosc = cos(pid_control_V4_ConstB.UnitConversion);
    _mm_storeu_pd(&pid_control_V4_B.Product_m[0], _mm_add_pd(_mm_mul_pd
      (_mm_set_pd(pid_control_V4_B.cosb, pid_control_V4_B.w1_c[0]), _mm_set_pd
       (pid_control_V4_B.w1_c[0], pid_control_V4_B.cosc)), _mm_mul_pd(_mm_mul_pd
      (_mm_set_pd(pid_control_V4_B.w1[0], pid_control_V4_B.cosb), _mm_set_pd
       (pid_control_V4_B.cosc, pid_control_V4_B.w1[0])), _mm_set_pd(1.0, -1.0))));
     ...
     *  Sum: '<S324>/Sum'
     */
    pid_control_V4_B.cosb = 0.0;
    pid_control_V4_B.cosc = 0.0;
    pid_control_V4_B.SignPreSat = 0.0;
    for (i = 0; i < 3; i++) {
      tmp_3 = _mm_add_pd(_mm_mul_pd(_mm_loadu_pd
        (&pid_control_V4_B.RotationAnglestoDirectionCo[3 * i]), _mm_set1_pd
        (pid_control_V4_B.Product_m[i])), _mm_set_pd(pid_control_V4_B.cosc,
        pid_control_V4_B.cosb));
      _mm_storeu_pd(&pid_control_V4_B.dv1[0], tmp_3);
      pid_control_V4_B.cosb = pid_control_V4_B.dv1[0];
      pid_control_V4_B.cosc = pid_control_V4_B.dv1[1];
      pid_control_V4_B.SignPreSat +=
        pid_control_V4_B.RotationAnglestoDirectionCo[3 * i + 2] *
        pid_control_V4_B.Product_m[i];
    }

    pid_control_V4_B.wbe_b[2] = pid_control_V4_B.SignPreSat;
    pid_control_V4_B.wbe_b[1] = pid_control_V4_B.cosc;
    pid_control_V4_B.wbe_b[0] = pid_control_V4_B.cosb;
   ...
   default:
    ...
    _mm_storeu_pd(&pid_control_V4_B.wbe_b[0], _mm_add_pd(_mm_mul_pd(_mm_set_pd
      (pid_control_V4_B.cosb, pid_control_V4_B.w1_c[0]), _mm_set_pd
      (pid_control_V4_B.w1_c[0], pid_control_V4_B.cosc)), _mm_mul_pd(_mm_mul_pd
      (_mm_set_pd(pid_control_V4_B.w1[0], pid_control_V4_B.cosb), _mm_set_pd
       (pid_control_V4_B.cosc, pid_control_V4_B.w1[0])), _mm_set_pd(1.0, -1.0))));
    ...
    for (i = 0; i < 3; i++) {
      tmp_3 = _mm_add_pd(_mm_mul_pd(_mm_loadu_pd
        (&pid_control_V4_B.RotationAnglestoDirectionCo[3 * i]), _mm_set1_pd
        (pid_control_V4_B.wbe_b[i])), _mm_set_pd(pid_control_V4_B.cosc,
        pid_control_V4_B.cosb));
      _mm_storeu_pd(&pid_control_V4_B.dv1[0], tmp_3);
      pid_control_V4_B.cosb = pid_control_V4_B.dv1[0];
      pid_control_V4_B.cosc = pid_control_V4_B.dv1[1];
      pid_control_V4_B.SignPreSat +=
        pid_control_V4_B.RotationAnglestoDirectionCo[3 * i + 2] *
        pid_control_V4_B.wbe_b[i];
    }

    pid_control_V4_B.Product_m[2] = pid_control_V4_B.SignPreSat;
    pid_control_V4_B.Product_m[1] = pid_control_V4_B.cosc;
    pid_control_V4_B.Product_m[0] = pid_control_V4_B.cosb;
    tmp_3 = _mm_add_pd(_mm_div_pd(_mm_mul_pd(_mm_sub_pd(_mm_set_pd
      ...
      (pid_control_V4_B.sinb), _mm_set1_pd(1000.0))), _mm_set1_pd
      (pid_control_V4_ConstB.Sum)), _mm_loadu_pd(&pid_control_V4_B.Product_m[0]));
     ...
     */
    pid_control_V4_B.wbe_b[2] = (pid_control_V4_B.LwgV1[1] -
      pid_control_V4_B.SignPreSat) * (pid_control_V4_B.sinb - 1000.0) /
      pid_control_V4_ConstB.Sum + pid_control_V4_B.SignPreSat;
  ...
  if (tmp_0) {
    ...
    pid_control_V4_B.SourceBlock_o1_h = Sub_pid_control_V3_417.getLatestMessage(
  ...
  if (pid_control_V4_DW.Hpgw_MODE) {
    /* Fcn: '<S301>/sqrt(0.8//V)' */
    pid_control_V4_B.w_r = sqrt(0.8 / pid_control_V4_B.sinc);

    /* Product: '<S301>/w3' */
    pid_control_V4_B.cosb = pid_control_V4_B.sinc * pid_control_V4_ConstB.w4;
    ...
    pid_control_V4_B.w_o[0] = (pid_control_V4_B.w_r / rt_powd_snf
      (pid_control_V4_B.cosa, 0.33333333333333331) * pid_control_V4_ConstB.u16 *
      pid_control_V4_B.Product[3] - pid_control_V4_X.pgw_p_CSTATE[0]) *
      pid_control_V4_B.cosb;

    /* Math: '<S301>/L^1//3' */
    if (pid_control_V4_B.frac[1] < 0.0) {
      pid_control_V4_B.cosa = -rt_powd_snf(-pid_control_V4_B.frac[1],
        0.33333333333333331);
    } else {
      pid_control_V4_B.cosa = rt_powd_snf(pid_control_V4_B.frac[1],
        0.33333333333333331);
     ...
     *  Sum: '<S301>/Sum'
     */
    pid_control_V4_B.w_o[1] = (pid_control_V4_B.w_r / pid_control_V4_B.cosa *
      pid_control_V4_ConstB.u16 * pid_control_V4_B.Product[3] -
      pid_control_V4_X.pgw_p_CSTATE[1]) * pid_control_V4_B.cosb;
  ...
  if (pid_control_V4_DW.Hqgw_MODE) {
    /* Gain: '<S302>/pi//4' */
    pid_control_V4_B.sina = 0.78539816339744828 * pid_control_V4_B.sinc;
     ...
     *  Sum: '<S302>/Sum'
     */
    pid_control_V4_B.cosa = (pid_control_V4_B.LwgV1[0] / pid_control_V4_B.sinc -
      pid_control_V4_X.qgw_p_CSTATE[0]) * (pid_control_V4_B.sina /
      pid_control_V4_ConstB.UnitConversion_n);
    pid_control_V4_B.w_e0[0] = pid_control_V4_B.cosa;

    /* UnaryMinus: '<S302>/Unary Minus' */
    pid_control_V4_B.UnaryMinus[0] = -pid_control_V4_B.cosa;
     ...
     *  Sum: '<S302>/Sum'
     */
    pid_control_V4_B.cosa = (pid_control_V4_B.LwgV1[1] / pid_control_V4_B.sinc -
      pid_control_V4_X.qgw_p_CSTATE[1]) * (pid_control_V4_B.sina /
      pid_control_V4_ConstB.UnitConversion_n);
    pid_control_V4_B.w_e0[1] = pid_control_V4_B.cosa;

    /* UnaryMinus: '<S302>/Unary Minus' */
    pid_control_V4_B.UnaryMinus[1] = -pid_control_V4_B.cosa;
  }
  ...
  if (pid_control_V4_DW.Hrgw_MODE) {
    ...
    tmp_3 = _mm_mul_pd(_mm_sub_pd(_mm_div_pd(_mm_loadu_pd(&pid_control_V4_B.w1[0]),
      _mm_set1_pd(pid_control_V4_B.sinc)), _mm_loadu_pd
      (&pid_control_V4_X.rgw_p_CSTATE[0])), _mm_div_pd(_mm_set1_pd
      (1.0471975511965976 * pid_control_V4_B.sinc), _mm_set1_pd
      (pid_control_V4_ConstB.UnitConversion_n)));
  ...
  switch (rtAction) {
   case 0:
    ...
    _mm_storeu_pd(&pid_control_V4_B.Product_m[0], _mm_add_pd(_mm_mul_pd
      (_mm_set_pd(pid_control_V4_B.sina, pid_control_V4_B.sigma_w[0]),
       _mm_set_pd(pid_control_V4_B.sigma_w[0], pid_control_V4_B.sinb)),
      _mm_mul_pd(_mm_mul_pd(_mm_set_pd(pid_control_V4_B.UnaryMinus[0],
   ...
   default:
    ...
    _mm_storeu_pd(&pid_control_V4_B.wbe_b[0], _mm_add_pd(_mm_mul_pd(_mm_set_pd
      ...
      (pid_control_V4_B.sigma_w[0], pid_control_V4_B.sinc)), _mm_mul_pd
      (_mm_mul_pd(_mm_set_pd(pid_control_V4_B.UnaryMinus[0],
      pid_control_V4_B.sina), _mm_set_pd(pid_control_V4_B.sinc,
      pid_control_V4_B.UnaryMinus[0])), _mm_set_pd(1.0, -1.0))));
    ...
    tmp_3 = _mm_add_pd(_mm_div_pd(_mm_mul_pd(_mm_sub_pd(_mm_set_pd
      ...
      (pid_control_V4_B.sinb), _mm_set1_pd(1000.0))), _mm_set1_pd
      (pid_control_V4_ConstB.Sum_a)), _mm_loadu_pd(&pid_control_V4_B.Product_m[0]));
    _mm_storeu_pd(&pid_control_V4_B.wbe_b[0], tmp_3);
    ...
    pid_control_V4_B.wbe_b[2] = (pid_control_V4_B.w_d[1] -
      pid_control_V4_B.SignPreSat) * (pid_control_V4_B.sinb - 1000.0) /
      pid_control_V4_ConstB.Sum_a + pid_control_V4_B.SignPreSat;
  ...
  if (tmp_0) {
    ...
    pid_control_V4_B.SourceBlock_o1_k = Sub_pid_control_V3_423.getLatestMessage(
  ...
  if (tmp_0) {
    ...
    pid_control_V4_B.SourceBlock_o1_c = Sub_pid_control_V3_443.getLatestMessage(
    ...
    pid_control_V4_B.SourceBlock_o1_d = Sub_pid_control_V3_445.getLatestMessage(
  ...
  pid_control_V4_B.cosa = 0.5303 * pid_control_V4_X.TransferFcn_CSTATE[0] + 0.0 *
  ...
  pid_control_V4_B.Sum[1] = pid_control_V4_B.Switch_p[1] + pid_control_V4_B.cosa;
