...
#ifndef pid_control_V3_types_h_
#define pid_control_V3_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_ros_gz_interfaces_Entity_
#define DEFINED_TYPEDEF_FOR_SL_Bus_ros_gz_interfaces_Entity_

struct SL_Bus_ros_gz_interfaces_Entity
{
  real_T id;
  uint8_T name[128];
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_ros_gz_interfaces_SetEntityPoseRequest_
#define DEFINED_TYPEDEF_FOR_SL_Bus_ros_gz_interfaces_SetEntityPoseRequest_

struct SL_Bus_ros_gz_interfaces_SetEntityPoseRequest
{
  SL_Bus_ros_gz_interfaces_Entity entity;
  SL_Bus_geometry_msgs_Pose pose;
};

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_ros_gz_interfaces_SetEntityPoseResponse_
#define DEFINED_TYPEDEF_FOR_SL_Bus_ros_gz_interfaces_SetEntityPoseResponse_

struct SL_Bus_ros_gz_interfaces_SetEntityPoseResponse
{
  boolean_T success;
};
...
typedef struct tag_RTM_pid_control_V3_T RT_MODEL_pid_control_V3_T;

#endif                                 /* pid_control_V3_types_h_ */
